...
var _locales = require("../routes/locales");

var _persona = require("../routes/persona");

var _reserva = require("../routes/reserva");
...
class Server {
  ...
  rutas() {
    this.app.use(_locales.locales_router);
    this.app.use(_persona.persona_router);
    this.app.use(_reserva.reserva_router);
